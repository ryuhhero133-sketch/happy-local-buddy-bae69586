...
export const DEX: Partial<Record<Species, SpeciesDex>> = {
  ...
  gloom_shiny: { types: ["Planta","Veneno"], moves: [m("Absorb","🌿","Baixo","Rouba HP"), m("Petal Dance","🌸","Muito Alto","Dança de pétalas"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Carregado")] },
  ...
  vileplume_shiny: { types: ["Planta","Veneno"], moves: [m("Petal Blizzard","🌸","Extremo","Tempestade de pétalas"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Carregado"), m("Sludge Bomb","☠️","Alto","Chance de veneno")] },
  ...
  caterpie_shiny: { types: ["Inseto"], moves: [m("Tackle","💥","Baixo","Investida"), m("String Shot","🕸️","Suporte","Reduz velocidade"), m("Bug Bite","🪲","Médio","Mordida inseto"), m("Silver Wind","🦋","Alto","Pode aumentar status")] },
  butterfree_shiny_plus: { types: ["Inseto","Voador"], moves: [m("Silver Wind","🦋","Alto","Pode aumentar status"), m("Sleep Powder","😴","Suporte","Sono"), m("Bug Buzz","🪲","Muito Alto","Pode reduzir Sp.Def"), m("Hurricane","🌀","Extremo","Furacão")] },
  ...
  paras_shiny: { types: ["Inseto","Planta"], moves: [m("Leech Life","🪲","Alto","Rouba HP"), m("Absorb","🌿","Baixo","Rouba HP"), m("Spore","😴","Suporte","Sono garantido"), m("X-Scissor","✂️","Alto","Corte cruzado")] },
  ...
  parasect_shiny: { types: ["Inseto","Planta"], moves: [m("X-Scissor","🪲","Alto","Corte cruzado"), m("Spore","😴","Suporte","Sono garantido"), m("Giga Drain","🌿","Alto","Rouba HP"), m("Leech Life","🪲","Muito Alto","Rouba muito HP")] },
  eevee:       { types: ["Normal"], moves: [m("Tackle","💥","Baixo","Investida"), m("Quick Attack","⚡","Médio","Prioridade"), m("Bite","🦷","Médio","Pode causar medo"), m("Body Slam","👊","Alto","Pode paralisar")] },
  ...
  cubone_shiny: { types: ["Terra"], moves: [m("Bone Club","🦴","Alto","Marra com osso"), m("Earthquake","🌎","Extremo","Tremor"), m("Headbutt","⚔️","Médio","Pode stunar"), m("Double Edge","💥","Muito Alto","Recuo")] },
  marowak:      { types: ["Terra"], moves: [m("Bone Club","🦴","Alto","Marra com osso"), m("Bonemerang","🦴","Muito Alto","Bumerangue de osso"), m("Earthquake","🌎","Extremo","Tremor"), m("Thrash","💥","Muito Alto","Fúria crescente")] },
  marowak_shiny: { types: ["Terra"], moves: [m("Bone Club","🦴","Alto","Marra com osso"), m("Bonemerang","🦴","Muito Alto","Bumerangue de osso"), m("Earthquake","🌎","Extremo","Tremor"), m("Thrash","💥","Muito Alto","Fúria crescente")] },
  marowak_plus: { types: ["Terra"], moves: [m("Bonemerang","🦴","Extremo","Bumerangue de osso"), m("Earthquake","🌎","Extremo","Tremor"), m("Skull Bash","💀","Muito Alto","Crânio brutal"), m("Thrash","💥","Muito Alto","Fúria crescente")] },
  rhyhorn:      { types: ["Pedra","Terra"], moves: [m("Horn Attack","🦏","Médio","Chifrada"), m("Rock Slide","🪨","Alto","Avalanche"), m("Earthquake","🌎","Alto","Tremor"), m("Stomp","🦶","Médio","Pisotão")] },
  rhyhorn_shiny: { types: ["Pedra","Terra"], moves: [m("Horn Attack","🦏","Médio","Chifrada"), m("Rock Slide","🪨","Alto","Avalanche"), m("Earthquake","🌎","Alto","Tremor"), m("Stomp","🦶","Médio","Pisotão")] },
  ...
  magmortar:   { types: ["Fogo"], moves: [m("Flamethrower","🔥","Alto","Lança chamas"), m("Fire Blast","🔥","Extremo","Bola de fogo"), m("Fire Punch","👊","Médio","Pode queimar"), m("Lava Plume","🌋","Alto","Erupção")] },
  electabuzz:  { types: ["Eletrico"], moves: [m("Thunder Shock","⚡","Baixo","Pode paralisar"), m("Thunderbolt","⚡","Alto","Raio"), m("Quick Attack","🏃","Médio","Prioridade"), m("Thunder","⚡","Extremo","Trovão")] },
  magneton:    { types: ["Eletrico","Aco"], moves: [m("Thunder Shock","⚡","Baixo","Pode paralisar"), m("Thunderbolt","⚡","Alto","Raio"), m("Magnet Bomb","🧲","Médio","Nunca erra"), m("Flash Cannon","✨","Alto","Raio de aço")] },
  blaziken:    { types: ["Fogo","Lutador"], moves: [m("Flamethrower","🔥","Alto","Lança chamas"), m("Blaze Kick","🔥","Alto","Crítico elevado"), m("Close Combat","🥊","Extremo","Reduz defesas"), m("Fire Blast","🔥","Extremo","Bola de fogo")] },
  ditto:       { types: ["Normal"], moves: [m("Tackle","💥","Baixo","Investida"), m("Quick Attack","⚡","Médio","Prioridade"), m("Body Slam","👊","Alto","Pode paralisar"), m("Transform","✨","Suporte","Copia o alvo")] },
  scizor:      { types: ["Inseto","Aco"], moves: [m("X-Scissor","✂️","Muito Alto","Corte cruzado"), m("Bullet Punch","👊","Médio","Prioridade alta"), m("Iron Head","⚙️","Alto","Cabeçada de aço"), m("Swords Dance","⚔️","Suporte","Aumenta ataque")] },
  umbreon:     { types: ["Sombrio"], moves: [m("Bite","🦷","Médio","Pode causar medo"), m("Quick Attack","🏃","Médio","Prioridade alta"), m("Night Slash","🌑","Alto","Crítico elevado"), m("Moonlight","🌙","Suporte","Recupera HP")] },
  ...
  // Rota Flower — planta/veneno, elétrico e psíquico (sprites 4x4)
  bellsprout_shiny: { types: ["Planta","Veneno"], moves: [m("Vine Whip","🍃","Médio","Chicote vegetal"), m("Razor Leaf","🌿","Alto","Crítico elevado"), m("Sleep Powder","😴","Suporte","Coloca para dormir"), m("Leaf Blade","🍃","Muito Alto","Lâmina afiada")] },
  weepinbell:    { types: ["Planta","Veneno"], moves: [m("Vine Whip","🍃","Médio","Chicote vegetal"), m("Razor Leaf","🌿","Alto","Crítico elevado"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Ataque carregado")] },
  weepinbell_shiny: { types: ["Planta","Veneno"], moves: [m("Razor Leaf","🌿","Alto","Crítico elevado"), m("Poison Jab","☠️","Alto","Chance de veneno"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Ataque carregado")] },
  victreebel:   { types: ["Planta","Veneno"], moves: [m("Leaf Blade","🍃","Muito Alto","Lâmina afiada"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Carregado"), m("Sludge Bomb","☠️","Alto","Chance de veneno")] },
  victreebel_shiny: { types: ["Planta","Veneno"], moves: [m("Leaf Storm","🌪️","Extremo","Tempestade de folhas"), m("Sleep Powder","😴","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Carregado"), m("Sludge Bomb","☠️","Alto","Chance de veneno")] },
  voltorb:      { types: ["Eletrico"], moves: [m("Tackle","💥","Baixo","Investida"), m("Thunder Shock","⚡","Médio","Pode paralisar"), m("Swift","⭐","Médio","Nunca erra"), m("Explosion","💥","Extremo","Auto destruição")] },
  voltorb_shiny: { types: ["Eletrico"], moves: [m("Thunder Shock","⚡","Médio","Pode paralisar"), m("Swift","⭐","Médio","Nunca erra"), m("Thunderbolt","⚡","Alto","Raio"), m("Explosion","💥","Extremo","Auto destruição")] },
  electrode:    { types: ["Eletrico"], moves: [m("Thunderbolt","⚡","Alto","Raio"), m("Swift","⭐","Médio","Nunca erra"), m("Thunder","⚡","Extremo","Trovão"), m("Explosion","💥","Extremo","Auto destruição")] },
  electrode_shiny: { types: ["Eletrico"], moves: [m("Thunderbolt","⚡","Alto","Raio"), m("Thunder","⚡","Extremo","Trovão"), m("Magnet Bomb","🧲","Alto","Nunca erra"), m("Explosion","💥","Extremo","Auto destruição")] },
  exeggcute:    { types: ["Planta","Psiquico"], moves: [m("Absorb","🌿","Baixo","Rouba HP"), m("Confusion","🧠","Médio","Pode confundir"), m("Hypnosis","😵","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Ataque carregado")] },
  exeggcute_shiny: { types: ["Planta","Psiquico"], moves: [m("Confusion","🧠","Médio","Pode confundir"), m("Psybeam","💫","Alto","Pode confundir"), m("Hypnosis","😵","Suporte","Sono"), m("Solar Beam","☀️","Extremo","Ataque carregado")] },
  exeggutor:    { types: ["Planta","Psiquico"], moves: [m("Confusion","🧠","Médio","Pode confundir"), m("Giga Drain","🌿","Alto","Rouba HP"), m("Solar Beam","☀️","Extremo","Carregado"), m("Psychic","🔮","Muito Alto","Onda psíquica")] },
  exeggutor_shiny: { types: ["Planta","Psiquico"], moves: [m("Psybeam","💫","Alto","Pode confundir"), m("Giga Drain","🌿","Alto","Rouba HP"), m("Solar Beam","☀️","Extremo","Carregado"), m("Psychic","🔮","Muito Alto","Onda psíquica")] },
  exeggutor_alola: { types: ["Planta","Dragao"], moves: [m("Dragon Breath","🐉","Médio","Pode paralisar"), m("Giga Drain","🌿","Alto","Rouba HP"), m("Solar Beam","☀️","Extremo","Carregado"), m("Draco Meteor","☄️","Extremo","Chuva de meteoros")] },
  exeggutor_alola_shiny: { types: ["Planta","Dragao"], moves: [m("Dragon Pulse","🐉","Muito Alto","Pulso dracônico"), m("Giga Drain","🌿","Alto","Rouba HP"), m("Solar Beam","☀️","Extremo","Carregado"), m("Draco Meteor","☄️","Extremo","Chuva de meteoros")] },
  snolax: { types: ["Agua"], moves: [m("Water Gun","💦","Baixo","Jato d'água"), m("Bubble Beam","🌀","Médio","Reduz velocidade"), m("Ice Beam","❄️","Alto","Chance congelar"), m("Hydro Pump","🌊","Muito Alto","Jato d'água")] },
  // Ruínas — pedra, fogo e planta (sprites 4x4)
  geodude:      { types: ["Pedra","Terra"], moves: [m("Tackle","💥","Baixo","Investida"), m("Rock Throw","🪨","Médio","Pedrada"), m("Defense Curl","🛡️","Suporte","Aumenta defesa"), m("Magnitude","🌎","Alto","Tremor variável")] },
  geodude_shiny: { types: ["Pedra","Terra"], moves: [m("Rock Throw","🪨","Médio","Pedrada"), m("Magnitude","🌎","Alto","Tremor variável"), m("Defense Curl","🛡️","Suporte","Aumenta defesa"), m("Earthquake","🌎","Extremo","Tremor")] },
  graveler:     { types: ["Pedra","Terra"], moves: [m("Rock Slide","🪨","Alto","Avalanche"), m("Magnitude","🌎","Alto","Tremor variável"), m("Defense Curl","🛡️","Suporte","Aumenta defesa"), m("Earthquake","🌎","Extremo","Tremor")] },
  graveler_shiny: { types: ["Pedra","Terra"], moves: [m("Rock Slide","🪨","Alto","Avalanche"), m("Stone Edge","⚔️","Muito Alto","Crítico elevado"), m("Defense Curl","🛡️","Suporte","Aumenta defesa"), m("Earthquake","🌎","Extremo","Tremor")] },
  graveler_alola: { types: ["Pedra","Eletrico"], moves: [m("Rock Throw","🪨","Médio","Pedrada"), m("Thunder Shock","⚡","Médio","Pode paralisar"), m("Thunder Wave","⚡","Suporte","Paralisa"), m("Explosion","💥","Extremo","Auto destruição")] },
  golem_shiny:  { types: ["Pedra","Terra"], moves: [m("Earthquake","🌎","Extremo","Tremor"), m("Rock Slide","🪨","Alto","Avalanche"), m("Stone Edge","⚔️","Muito Alto","Crítico elevado"), m("Explosion","💥","Extremo","Auto destruição")] },
  golem_plus:   { types: ["Pedra","Terra"], moves: [m("Stone Edge","⚔️","Muito Alto","Crítico elevado"), m("Earthquake","🌎","Extremo","Tremor"), m("Rock Wrecker","🪨","Extremo","Canhão de pedra"), m("Explosion","💥","Extremo","Auto destruição")] },
  arcanine_shiny: { types: ["Fogo"], moves: [m("Flamethrower","🔥","Alto","Lança chamas"), m("Extreme Speed","⚡","Médio","Sempre ataca primeiro"), m("Fire Blast","🔥","Extremo","Bola de fogo"), m("Dragon Pulse","🐉","Muito Alto","Pulso dracônico")] },
  arcanine_shiny_plus: { types: ["Fogo"], moves: [m("Burn Up","🔥","Extremo","Chama total"), m("Extreme Speed","⚡","Médio","Sempre ataca primeiro"), m("Fire Blast","🔥","Extremo","Bola de fogo"), m("Outrage","🐉","Muito Alto","Fúria dracônica")] },
  growlithe_shiny: { types: ["Fogo"], moves: [m("Ember","🔥","Baixo","Pode queimar"), m("Bite","🦷","Médio","Pode causar medo"), m("Flamethrower","🔥","Alto","Chance de queimar"), m("Flare Blitz","🔥","Muito Alto","Investida flamejante")] },
  sprigatito:   { types: ["Planta"], moves: [m("Scratch","⚔️","Baixo","Arranhão"), m("Leafage","🍃","Médio","Chuva de folhas"), m("Hone Claws","✨","Suporte","Afia as garras"), m("Seed Bomb","🌱","Alto","Bomba de sementes")] },
  sprigatito_shiny: { types: ["Planta"], moves: [m("Leafage","🍃","Médio","Chuva de folhas"), m("Magical Leaf","✨","Alto","Nunca erra"), m("Hone Claws","✨","Suporte","Afia as garras"), m("Seed Bomb","🌱","Alto","Bomba de sementes")] },
  // Ruínas de Vênus — veneno e fantasma (sprites 4x4)
  ekans_shiny: { types: ["Veneno"], moves: [m("Poison Sting","☠️","Baixo","Chance de veneno"), m("Bite","🦷","Médio","Pode causar medo"), m("Acid","🧪","Médio","Spray ácido"), m("Poison Fang","☠️","Alto","Chance veneno")] },
  arbok_shiny: { types: ["Veneno"], moves: [m("Poison Fang","☠️","Médio","Chance veneno"), m("Crunch","🦷","Alto","Mordida"), m("Sludge Bomb","☠️","Alto","Chance de veneno"), m("Glare","👁️","Suporte","Paralisa")] },
  gastly:      { types: ["Veneno","Fantasma"], moves: [m("Lick","👅","Baixo","Pode paralisar"), m("Confuse Ray","💫","Suporte","Confunde"), m("Night Shade","🌑","Médio","Dano fixo"), m("Shadow Ball","⚫","Alto","Bola sombria")] },
  gastly_shiny: { types: ["Veneno","Fantasma"], moves: [m("Lick","👅","Baixo","Pode paralisar"), m("Confuse Ray","💫","Suporte","Confunde"), m("Night Shade","🌑","Médio","Dano fixo"), m("Hex","🔮","Alto","Dano dobrado")] },
  haunter:     { types: ["Veneno","Fantasma"], moves: [m("Shadow Punch","👊","Médio","Nunca erra"), m("Confuse Ray","💫","Suporte","Confunde"), m("Night Shade","🌑","Médio","Dano fixo"), m("Shadow Ball","⚫","Alto","Bola sombria")] },
  haunter_shiny: { types: ["Veneno","Fantasma"], moves: [m("Shadow Punch","👊","Médio","Nunca erra"), m("Hex","🔮","Alto","Dano dobrado"), m("Night Shade","🌑","Médio","Dano fixo"), m("Shadow Ball","⚫","Alto","Bola sombria")] },
  gengar:      { types: ["Veneno","Fantasma"], moves: [m("Shadow Ball","⚫","Alto","Bola sombria"), m("Sludge Bomb","☠️","Alto","Chance de veneno"), m("Psychic","🔮","Muito Alto","Onda psíquica"), m("Recover","✨","Suporte","Recupera HP")] },
  grimer:      { types: ["Veneno"], moves: [m("Pound","👊","Baixo","Soco"), m("Poison Gas","☠️","Suporte","Pode envenenar"), m("Sludge","🧪","Médio","Lama tóxica"), m("Acid Armor","🛡️","Suporte","Aumenta defesa")] },
  grimer_shiny: { types: ["Veneno"], moves: [m("Pound","👊","Baixo","Soco"), m("Poison Gas","☠️","Suporte","Pode envenenar"), m("Sludge Bomb","☠️","Alto","Chance de veneno"), m("Acid Armor","🛡️","Suporte","Aumenta defesa")] },
  muk:         { types: ["Veneno"], moves: [m("Sludge","🧪","Médio","Lama tóxica"), m("Poison Gas","☠️","Suporte","Pode envenenar"), m("Body Slam","👊","Alto","Pode paralisar"), m("Gunk Shot","☠️","Muito Alto","Lixo tóxico")] },
  muk_shiny:   { types: ["Veneno"], moves: [m("Sludge Bomb","☠️","Alto","Chance de veneno"), m("Poison Gas","☠️","Suporte","Pode envenenar"), m("Body Slam","👊","Alto","Pode paralisar"), m("Gunk Shot","☠️","Muito Alto","Lixo tóxico")] },
  swalot:      { types: ["Veneno"], moves: [m("Sludge","🧪","Médio","Lama tóxica"), m("Amnesia","🧠","Suporte","Aumenta Sp.Def"), m("Body Slam","👊","Alto","Pode paralisar"), m("Gunk Shot","☠️","Muito Alto","Lixo tóxico")] },
  swalot_shiny: { types: ["Veneno"], moves: [m("Sludge Bomb","☠️","Alto","Chance de veneno"), m("Amnesia","🧠","Suporte","Aumenta Sp.Def"), m("Body Slam","👊","Alto","Pode paralisar"), m("Gunk Shot","☠️","Muito Alto","Lixo tóxico")] },
  // Mapa Dos Céus — voadores (sprites 4x4)
  zubat_shiny: { types: ["Veneno","Voador"], moves: [m("Bite","🦷","Médio","Pode causar medo"), m("Wing Attack","🌪️","Médio","Asas"), m("Poison Fang","☠️","Médio","Chance veneno"), m("Air Cutter","🌪️","Alto","Crítico elevado")] },
  pidgey_shiny: { types: ["Normal","Voador"], moves: [m("Gust","🌪️","Baixo","Rajada"), m("Quick Attack","⚡","Médio","Prioridade"), m("Sand Attack","🪶","Suporte","Reduz precisão"), m("Wing Attack","🪽","Médio","Asas")] },
  pidgeotto_shiny: { types: ["Normal","Voador"], moves: [m("Wing Attack","🌪️","Médio","Asas"), m("Quick Attack","⚡","Médio","Prioridade"), m("Feather Dance","🪶","Suporte","Reduz ataque"), m("Air Slash","🌪️","Alto","Lâmina de ar")] },
  pidgeot_shiny: { types: ["Normal","Voador"], moves: [m("Air Slash","🌪️","Alto","Lâmina de ar"), m("Hurricane","🌀","Muito Alto","Furacão"), m("Quick Attack","⚡","Médio","Prioridade"), m("Brave Bird","🦅","Extremo","Investida aérea")] },
  spearow:     { types: ["Normal","Voador"], moves: [m("Peck","🐦","Baixo","Bicada"), m("Fury Attack","⚔️","Médio","Multi-hit"), m("Quick Attack","⚡","Médio","Prioridade"), m("Aerial Ace","🌪️","Alto","Nunca erra")] },
  spearow_shiny: { types: ["Normal","Voador"], moves: [m("Peck","🐦","Baixo","Bicada"), m("Fury Attack","⚔️","Médio","Multi-hit"), m("Quick Attack","⚡","Médio","Prioridade"), m("Drill Peck","🪶","Alto","Bicada brutal")] },
  golbat:      { types: ["Veneno","Voador"], moves: [m("Bite","🦷","Médio","Pode causar medo"), m("Wing Attack","🌪️","Médio","Asas"), m("Poison Fang","☠️","Alto","Chance veneno"), m("Air Cutter","🌪️","Alto","Crítico elevado")] },
  golbat_shiny: { types: ["Veneno","Voador"], moves: [m("Poison Fang","☠️","Alto","Chance veneno"), m("Wing Attack","🌪️","Médio","Asas"), m("Confuse Ray","💫","Suporte","Confunde"), m("Air Cutter","🌪️","Alto","Crítico elevado")] },
  fearow_shiny: { types: ["Normal","Voador"], moves: [m("Drill Peck","🪶","Alto","Bicada brutal"), m("Fury Attack","⚔️","Médio","Multi-hit"), m("Aerial Ace","🌪️","Alto","Nunca erra"), m("Sky Attack","☀️","Extremo","Ataque carregado")] },
};
