...
export const SPECIES_BASE: Record<Species, { hp: number; atk: number; def: number; spa: number; spd: number; spe: number; rarity: Rarity; goldRange: [number, number]; crystalChance: number; catchMod: number; minLv: number }> = {
  ...
  zapdos:          { hp: 90, atk: 90, def: 85, spa: 125, spd: 90, spe: 100, rarity: "mythic", goldRange: [50, 85], crystalChance: 0.3, catchMod: 2.2, minLv: 90 },
  articuno:        { hp: 90, atk: 85, def: 100, spa: 95, spd: 125, spe: 85, rarity: "mythic", goldRange: [50, 85], crystalChance: 0.3, catchMod: 2.2, minLv: 90 },
  mew:             { hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100, rarity: "mythic", goldRange: [60, 100], crystalChance: 0.35, catchMod: 2.4, minLv: 90 },
  lucario:         { hp: 70, atk: 110, def: 70, spa: 115, spd: 70, spe: 90, rarity: "mythic", goldRange: [55, 95], crystalChance: 0.325, catchMod: 2.3, minLv: 90 },
  virizion:        { hp: 91, atk: 90, def: 72, spa: 90, spd: 129, spe: 108, rarity: "epic", goldRange: [45, 80], crystalChance: 0.275, catchMod: 2.1, minLv: 80 },
  raikou:          { hp: 90, atk: 85, def: 75, spa: 115, spd: 100, spe: 115, rarity: "epic", goldRange: [47, 85], crystalChance: 0.3, catchMod: 2.15, minLv: 82 },
  suicune:         { hp: 100, atk: 75, def: 115, spa: 90, spd: 115, spe: 85, rarity: "mythic", goldRange: [60, 100], crystalChance: 0.35, catchMod: 2.35, minLv: 88 },
  suicune_shiny:   { hp: 110, atk: 85, def: 125, spa: 100, spd: 125, spe: 95, rarity: "mythic_shiny", goldRange: [80, 130], crystalChance: 0.425, catchMod: 2.6, minLv: 92 },
  luxray_f:        { hp: 80, atk: 120, def: 79, spa: 95, spd: 79, spe: 70, rarity: "epic", goldRange: [42, 75], crystalChance: 0.25, catchMod: 2.0, minLv: 78 },
  ...
  vaporeon:   { hp: 130, atk: 65, def: 60, spa: 110, spd: 95, spe: 65, rarity: "epic", goldRange: [22, 37], crystalChance: 0.11, catchMod: 1.55, minLv: 24 },
  dragonair:  { hp: 61, atk: 84, def: 65, spa: 70, spd: 70, spe: 70, rarity: "epic", goldRange: [20, 35], crystalChance: 0.1, catchMod: 1.5, minLv: 22 },
  gyarados:        { hp: 95, atk: 125, def: 79, spa: 60, spd: 100, spe: 81, rarity: "epic", goldRange: [25, 42], crystalChance: 0.125, catchMod: 1.6, minLv: 28 },
  jolteon:         { hp: 65, atk: 65, def: 60, spa: 110, spd: 95, spe: 130, rarity: "epic", goldRange: [22, 37], crystalChance: 0.11, catchMod: 1.55, minLv: 24 },
  jolteon_shiny:   { hp: 70, atk: 70, def: 65, spa: 115, spd: 100, spe: 135, rarity: "mythic", goldRange: [45, 80], crystalChance: 0.25, catchMod: 2.0, minLv: 90 },
  vaporeon_shiny:  { hp: 140, atk: 70, def: 65, spa: 115, spd: 100, spe: 70, rarity: "mythic", goldRange: [45, 80], crystalChance: 0.25, catchMod: 2.0, minLv: 90 },
  flareon:         { hp: 65, atk: 130, def: 60, spa: 95, spd: 110, spe: 65, rarity: "epic", goldRange: [22, 37], crystalChance: 0.11, catchMod: 1.55, minLv: 24 },
  flareon_shiny:   { hp: 70, atk: 135, def: 65, spa: 100, spd: 115, spe: 70, rarity: "mythic", goldRange: [45, 80], crystalChance: 0.25, catchMod: 2.0, minLv: 90 },
  snorlax:         { hp: 160, atk: 110, def: 65, spa: 65, spd: 110, spe: 30, rarity: "epic", goldRange: [25, 45], crystalChance: 0.125, catchMod: 1.65, minLv: 30 },
  dragonite_shiny: { hp: 100, atk: 140, def: 100, spa: 105, spd: 105, spe: 85, rarity: "mythic_shiny", goldRange: [70, 110], crystalChance: 0.375, catchMod: 2.5, minLv: 90 },
  mew_alt:         { hp: 110, atk: 110, def: 110, spa: 110, spd: 110, spe: 110, rarity: "mythic_shiny", goldRange: [75, 115], crystalChance: 0.4, catchMod: 2.6, minLv: 90 },
  raichu:          { hp: 60, atk: 90, def: 55, spa: 90, spd: 80, spe: 110, rarity: "epic", goldRange: [20, 35], crystalChance: 0.1, catchMod: 1.5, minLv: 22 },
  weedle:          { hp: 40, atk: 35, def: 30, spa: 20, spd: 20, spe: 50, rarity: "common", goldRange: [1, 4], crystalChance: 0, catchMod: 0.7, minLv: 2 },
  weedle_shiny:    { hp: 45, atk: 40, def: 35, spa: 25, spd: 25, spe: 55, rarity: "rare", goldRange: [12, 25], crystalChance: 0.075, catchMod: 1.2, minLv: 6 },
  kakuna:          { hp: 45, atk: 25, def: 50, spa: 25, spd: 25, spe: 35, rarity: "common", goldRange: [2, 4], crystalChance: 0, catchMod: 0.7, minLv: 4 },
  kakuna_shiny:    { hp: 50, atk: 30, def: 55, spa: 30, spd: 30, spe: 40, rarity: "rare", goldRange: [12, 25], crystalChance: 0.075, catchMod: 1.2, minLv: 8 },
  metapod_shiny:   { hp: 55, atk: 25, def: 60, spa: 30, spd: 30, spe: 35, rarity: "rare", goldRange: [12, 25], crystalChance: 0.075, catchMod: 1.2, minLv: 8 },
  butterfree_shiny:{ hp: 70, atk: 50, def: 55, spa: 100, spd: 90, spe: 75, rarity: "mythic", goldRange: [45, 80], crystalChance: 0.25, catchMod: 2.0, minLv: 90 },
  rattata_f:       { hp: 30, atk: 56, def: 35, spa: 25, spd: 35, spe: 72, rarity: "common", goldRange: [1, 4], crystalChance: 0, catchMod: 0.8, minLv: 2 },
  raticate_f:      { hp: 55, atk: 81, def: 60, spa: 50, spd: 70, spe: 97, rarity: "rare", goldRange: [9, 16], crystalChance: 0.045, catchMod: 1.25, minLv: 12 },
  sandshrew:       { hp: 50, atk: 75, def: 85, spa: 20, spd: 30, spe: 40, rarity: "uncommon", goldRange: [4, 7], crystalChance: 0.015, catchMod: 1.0, minLv: 5 },
  ...
  blastoise_shiny: { hp: 90, atk: 95, def: 115, spa: 100, spd: 120, spe: 90, rarity: "mythic", goldRange: [50, 90], crystalChance: 0.275, catchMod: 2.1, minLv: 90 },
  // ===== Pack POKÉDEX (Ruby M) =====
  ...
  nidoking:        { hp: 81, atk: 102, def: 77, spa: 85, spd: 75, spe: 85, rarity: "epic", goldRange: [21, 35], crystalChance: 0.11, catchMod: 1.55, minLv: 26 },
  nidoran_f:       { hp: 55, atk: 47, def: 52, spa: 40, spd: 40, spe: 41, rarity: "uncommon", goldRange: [4, 7], crystalChance: 0.015, catchMod: 1.0, minLv: 4 },
  ...
  psyduck:         { hp: 50, atk: 52, def: 48, spa: 65, spd: 50, spe: 55, rarity: "uncommon", goldRange: [5, 9], crystalChance: 0.025, catchMod: 1.0, minLv: 6 },
  ...
  lapras_shiny:    { hp: 130, atk: 85, def: 80, spa: 95, spd: 95, spe: 60, rarity: "mythic_shiny", goldRange: [250, 450], crystalChance: 0.45, catchMod: 3.0, minLv: 500 },
  snorlax_mythic:  { hp: 160, atk: 110, def: 65, spa: 65, spd: 110, spe: 30, rarity: "mythic_shiny", goldRange: [250, 450], crystalChance: 0.45, catchMod: 3.0, minLv: 500 },
  darkrai:         { hp: 140, atk: 180, def: 100, spa: 200, spd: 120, spe: 160, rarity: "mythic_shiny", goldRange: [450, 750], crystalChance: 0.49, catchMod: 5.5, minLv: 500 },
  ho_oh:           { hp: 106, atk: 130, def: 90, spa: 110, spd: 154, spe: 90, rarity: "legendary", goldRange: [75, 130], crystalChance: 0.275, catchMod: 2.4, minLv: 70 },
  magmortar:       { hp: 75, atk: 95, def: 67, spa: 125, spd: 95, spe: 83, rarity: "epic", goldRange: [40, 75], crystalChance: 0.2, catchMod: 1.9, minLv: 40 },
  lugia:           { hp: 200, atk: 170, def: 155, spa: 190, spd: 220, spe: 130, rarity: "mythic_shiny", goldRange: [750, 1400], crystalChance: 1.0, catchMod: 6.5, minLv: 600 },
  hariyama:        { hp: 144, atk: 120, def: 60, spa: 40, spd: 60, spe: 50, rarity: "legendary", goldRange: [110, 190], crystalChance: 0.3, catchMod: 2.6, minLv: 250 },
  ursaring:        { hp: 130, atk: 140, def: 75, spa: 55, spd: 75, spe: 55, rarity: "mythic", goldRange: [160, 260], crystalChance: 0.375, catchMod: 3.2, minLv: 340 },
  // Guardiões Anti-Paralisia
  ...
  scizor:          { hp: 70, atk: 130, def: 100, spa: 55, spd: 80, spe: 65, rarity: "epic", goldRange: [45, 80], crystalChance: 0.2, catchMod: 2.0, minLv: 100 },
  umbreon:         { hp: 95, atk: 65, def: 110, spa: 60, spd: 130, spe: 65, rarity: "epic", goldRange: [47, 85], crystalChance: 0.21, catchMod: 2.1, minLv: 100 },
  // Apex — bosses raros Lv 300-700 (crit alto, difícil de capturar)
  infernape:       { hp: 76,  atk: 104, def: 71,  spa: 104, spd: 71,  spe: 108, rarity: "epic",         goldRange: [160, 270], crystalChance: 0.35, catchMod: 3.2, minLv: 300 },
  krookodile:      { hp: 95,  atk: 117, def: 80,  spa: 65,  spd: 70,  spe: 92,  rarity: "legendary",    goldRange: [220, 360], crystalChance: 0.4, catchMod: 3.6, minLv: 350 },
  tyranitar:       { hp: 100, atk: 134, def: 110, spa: 95,  spd: 100, spe: 61,  rarity: "mythic",       goldRange: [310, 490], crystalChance: 0.45, catchMod: 4.2, minLv: 500 },
  nidoking_shiny:  { hp: 81,  atk: 122, def: 87,  spa: 105, spd: 85,  spe: 95,  rarity: "mythic_shiny", goldRange: [475, 750],crystalChance: 0.49, catchMod: 5.2, minLv: 600 },
  rapidash:        { hp: 65,  atk: 100, def: 70,  spa: 80,  spd: 80,  spe: 105, rarity: "epic",         goldRange: [170, 280], crystalChance: 0.36, catchMod: 3.2, minLv: 300 },
  rapidash_shiny:  { hp: 65,  atk: 100, def: 70,  spa: 80,  spd: 80,  spe: 105, rarity: "legendary",    goldRange: [250, 410], crystalChance: 0.425, catchMod: 3.8, minLv: 400 },
  skarmory:        { hp: 65,  atk: 80,  def: 140, spa: 40,  spd: 70,  spe: 70,  rarity: "legendary",    goldRange: [230, 380], crystalChance: 0.4, catchMod: 3.6, minLv: 350 },
  // Edição especial — Dialga (evento 3h em 3h, Lv 800)
  dialga:          { hp: 100, atk: 120, def: 120, spa: 150, spd: 100, spe: 90,  rarity: "mythic_shiny", goldRange: [1200, 2000], crystalChance: 1.0, catchMod: 8.0, minLv: 800 },
  // ═══ MTC — Míticos Brilhantes (aparecem Lv 500-1000, só ultra ball) ═══
  abomasnow:       { hp: 90,  atk: 92,  def: 75,  spa: 92,  spd: 85,  spe: 60,  rarity: "mythic_shiny", goldRange: [600, 1000], crystalChance: 0.475, catchMod: 6.0, minLv: 500 },
  cloyster:        { hp: 50,  atk: 95,  def: 180, spa: 85,  spd: 45,  spe: 70,  rarity: "mythic_shiny", goldRange: [650, 1050], crystalChance: 0.475, catchMod: 6.0, minLv: 500 },
  ...
  hitmonchan_shiny:{ hp: 50,  atk: 105, def: 79,  spa: 35,  spd: 110, spe: 76,  rarity: "mythic_shiny", goldRange: [700, 1100], crystalChance: 0.48, catchMod: 6.2, minLv: 550 },
  kangaskhan:      { hp: 105, atk: 95,  def: 80,  spa: 40,  spd: 80,  spe: 90,  rarity: "mythic_shiny", goldRange: [650, 1050], crystalChance: 0.475, catchMod: 6.0, minLv: 500 },
  meganium:        { hp: 80,  atk: 82,  def: 100, spa: 83,  spd: 100, spe: 80,  rarity: "mythic_shiny", goldRange: [650, 1050], crystalChance: 0.475, catchMod: 6.0, minLv: 500 },
  meganium_shiny:  { hp: 80,  atk: 82,  def: 100, spa: 83,  spd: 100, spe: 80,  rarity: "mythic_shiny", goldRange: [800, 1250], crystalChance: 0.49, catchMod: 6.5, minLv: 600 },
  moltres_shiny:   { hp: 90,  atk: 100, def: 90,  spa: 125, spd: 85,  spe: 90,  rarity: "mythic_shiny", goldRange: [900, 1400], crystalChance: 0.495, catchMod: 7.0, minLv: 700 },
  onix_shiny:      { hp: 35,  atk: 45,  def: 180, spa: 30,  spd: 45,  spe: 70,  rarity: "mythic_shiny", goldRange: [700, 1100], crystalChance: 0.48, catchMod: 6.2, minLv: 550 },
  // Odisséia Oddish
  lickitung:        { hp: 90,  atk: 55,  def: 75,  spa: 60,  spd: 75,  spe: 30,  rarity: "epic",         goldRange: [35, 65],   crystalChance: 0.15, catchMod: 1.8, minLv: 20 },
  lickitung_shiny:  { hp: 90,  atk: 55,  def: 75,  spa: 60,  spd: 75,  spe: 30,  rarity: "legendary",    goldRange: [110, 190],  crystalChance: 0.3, catchMod: 2.6, minLv: 40 },
  mewtwo_event:     { hp: 106, atk: 110, def: 90,  spa: 154, spd: 90,  spe: 130, rarity: "mythic_shiny", goldRange: [1500, 2500],crystalChance: 1.0,  catchMod: 9.0, minLv: 300 },
  oddish_shiny:     { hp: 55,  atk: 55,  def: 60,  spa: 85,  spd: 75,  spe: 45,  rarity: "legendary",    goldRange: [140, 230],  crystalChance: 0.35, catchMod: 3.2, minLv: 1 },
  riolu:            { hp: 95,  atk: 130, def: 90,  spa: 125, spd: 90,  spe: 110, rarity: "mythic_shiny", goldRange: [200, 350], crystalChance: 0.475, catchMod: 3.0, minLv: 500 },
  rayquaza:         { hp: 105, atk: 150, def: 90,  spa: 150, spd: 90,  spe: 95,  rarity: "mythic_shiny", goldRange: [250, 450], crystalChance: 1.0,  catchMod: 4.0, minLv: 500 },
};
...
export const SHOP: ShopItem[] = [
  ...
  { id: "maca",      name: "Maçã",            desc: "Alimenta: +25 fome, +15 energia", price: 200, currency: "gold", icon: "🍎" },
  { id: "laranja",   name: "Laranja",         desc: "Alimenta: +25 fome, +15 energia", price: 200, currency: "gold", icon: "🍊" },
  { id: "picole",    name: "Picolé",          desc: "Alimenta: +25 fome, +20 energia", price: 300, currency: "gold", icon: "🍧" },
  { id: "refrigerante", name: "Refrigerante", desc: "Alimenta: +20 fome, +35 energia", price: 600, currency: "gold", icon: "🥤" },
  { id: "cafe",      name: "Café Expresso",   desc: "Alimenta: +15 fome, +45 energia", price: 500, currency: "gold", icon: "☕" },
  { id: "cha_verde", name: "Chá Verde",       desc: "Alimenta: +15 fome, +30 energia", price: 350, currency: "gold", icon: "🍵" },
  { id: "bolo_morango", name: "Bolo de Morango", desc: "Alimenta: +60 fome, +40 energia", price: 1200, currency: "gold", icon: "🍰" },
  { id: "leite_manga", name: "Leite de Manga", desc: "Alimenta: +35 fome, +25 energia", price: 700, currency: "gold", icon: "🧋" },
