...
const IDLE_MAPS: Record<IdleMapId, IdleMapDef> = {
  ...
  continente_4: { name: "Continente 4", diff: "SECRETO", bg: mapContinente4Img, rate: 25.0, minLevel: 1, maxLevel: 5000, element: "Desconhecido", stars: 10, overlay: "rgba(100, 40, 180, 0.45)", zoomOverride: 0.5, x: 1000, y: 1000 },
