...
function TabOverlay({
  ...
  return (
    <div style={{
      ...
      {tab === "loja" && (
        <div style={{ padding: 40, textAlign: "center", color: "#fca5a5", background: "rgba(0,0,0,0.95)", borderRadius: 12, border: "2px solid #f87171", margin: 20, position: "absolute", inset: 0, zIndex: 100 }}>
          <div style={{ fontSize: 60, marginBottom: 20 }}>🔒</div>
          <h2 style={{ margin: 0 }}>LOJA BLOQUEADA</h2>
          <p style={{ fontSize: 16, opacity: 0.8 }}>O sistema de loja está temporariamente indisponível por ordem da administração.</p>
        </div>
      /*
      ...
      {tab === "market" && (
        <div style={{ padding: 40, textAlign: "center", color: "#fca5a5", background: "rgba(0,0,0,0.95)", borderRadius: 12, border: "2px solid #f87171", margin: 20, position: "absolute", inset: 0, zIndex: 100 }}>
          <div style={{ fontSize: 60, marginBottom: 20 }}>🔒</div>
          <h2 style={{ margin: 0 }}>MERCADO BLOQUEADO</h2>
          <p style={{ fontSize: 16, opacity: 0.8 }}>O mercado global está em manutenção e foi desativado.</p>
        </div>
      /*
        <div style={{ padding: 20, textAlign: "center", color: "#fca5a5", background: "rgba(255,0,0,0.1)", borderRadius: 12, border: "1px dashed #f87171" }}>
          <div style={{ fontSize: 40, marginBottom: 10 }}>🔒</div>
