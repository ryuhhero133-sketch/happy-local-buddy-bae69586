...
function IdlePage() {
  ...
  return (
    <div style={{
          ...
          <div className="trainer-info-minimal">
            ...
            <div className="stats-pill-group">
              ...
              <div className="stat-pill-xp">
                <div className="stat-pill-fill" style={{ width: `${(idle.trainerXp / trainerXpToNext(idle.trainerLevel)) * 100}%`, background: "var(--xp-gradient)" }} />
                <span className="stat-pill-label">XP {Math.floor((idle.trainerXp / trainerXpToNext(idle.trainerLevel)) * 100)}%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Container do Mapa (Ocupa 85-100% da tela abaixo das HUDs flutuantes) */}
