...
function TabOverlay({
  ...
  const title =
    effectiveTab === "pokemon"   ? "MEU POKÉMON" :
    effectiveTab === "mochila"   ? "MOCHILA" :
    effectiveTab === "colecao"   ? "COLEÇÃO" :
    effectiveTab === "pokedex"   ? "POKÉDEX" :
    effectiveTab === "loja"      ? "LOJA BLOQUEADA" :
    effectiveTab === "wallet"    ? "CARTEIRA" :
    effectiveTab === "market"    ? "MERCADO BLOQUEADO" :

    effectiveTab === "melhorias" ? "MELHORIAS" :
    effectiveTab === "config"    ? "CONFIGURAÇÕES" :
    effectiveTab === "tarefas"   ? "TAREFAS" :
    effectiveTab === "inicio"    ? "INÍCIO" : "";
