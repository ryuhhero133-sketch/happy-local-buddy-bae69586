...
function createSupabaseAdminClient() {
  ...
  // V29: Verificação explícita de ADMIN_SB_KEY em process.env
  ...
  if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
    ...
    const message = `Erro: Configuração incompleta (${missing.join(', ')}).`;
    console.error(`[Admin Client Error] Missing: ${missing.join(', ')}`);
